    ...
    def _build_net_2(self):
        ...
        with tf.variable_scope('eval_net',reuse=None):
            c_names, n_l1, n_l2, n_l3, w_initializer, b_initializer = \
                ['eval_net_params', tf.GraphKeys.GLOBAL_VARIABLES], self.n_l1, self.n_l2, self.n_l3, tf.random_normal_initializer(0., 0.3), tf.constant_initializer(0.1)  # config of layers
